...
Al haber analizado la gráfica de densidad de median_house_value, se miraba una anomalía en la cola de la distribución. Se ha eliminado esta
...
```{r}
TrainSNoNa <- cbind(id = TrainNoNa$id,TrainSNoNa,median_house_value = TrainNoNa$median_house_value, ocean_proximity_1H_Ocean = TrainNoNa$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainNoNa$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainNoNa$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainNoNa$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainNoNa$`ocean_proximity_NEAR OCEAN`)
...
```
```{r}
TrainSMedian <- cbind(id = TrainMedian$id,TrainSMedian,median_house_value = TrainMedian$median_house_value, ocean_proximity_1H_Ocean = TrainMedian$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainMedian$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainMedian$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainMedian$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainMedian$`ocean_proximity_NEAR OCEAN`)
...
```
```{r}
TrainSMean <- cbind(id = TrainMean$id,TrainSMean,median_house_value = TrainMean$median_house_value, ocean_proximity_1H_Ocean = TrainMean$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainMean$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainMean$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainMean$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainMean$`ocean_proximity_NEAR OCEAN`)
...
```
```{r}
TrainSUNoNa <- cbind(id = TrainUNoNa$id,TrainSUNoNa,median_house_value = TrainUNoNa$median_house_value, ocean_proximity_1H_Ocean = TrainUNoNa$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainUNoNa$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainUNoNa$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainUNoNa$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainUNoNa$`ocean_proximity_NEAR OCEAN`)
...
```
```{r}
TrainSUMedian <- cbind(id = TrainUMedian$id,TrainSUMedian,median_house_value = TrainUMedian$median_house_value, ocean_proximity_1H_Ocean = TrainUMedian$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainUMedian$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainUMedian$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainUMedian$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainUMedian$`ocean_proximity_NEAR OCEAN`)
...
```
```{r}
TrainSUMean <- cbind(id = TrainUMean$id,TrainSUMean,median_house_value = TrainUMean$median_house_value, ocean_proximity_1H_Ocean = TrainUMean$`ocean_proximity_<1H OCEAN`, ocean_proximity_INLAND = TrainUMean$ocean_proximity_INLAND, ocean_proximity_ISLAND = TrainUMean$ocean_proximity_ISLAND, ocean_proximity_NEAR_BAY = TrainUMean$`ocean_proximity_NEAR BAY`, ocean_proximity_NEAR_OCEAN = TrainUMean$`ocean_proximity_NEAR OCEAN`)
