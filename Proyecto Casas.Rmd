...
En la exploración de datos, se determinó que las variables del set de entrenamiento no poseen relaciones lineales, por lo que se desea probar los siguientes modelos:
