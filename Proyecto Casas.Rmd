...
Puede observarse una discrepancia en el número de datos en *total_bedrooms*. Esto puede deberse a valores nulos o *NA*. Para verificar esto, se analiza la columna
